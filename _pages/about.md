...
* Led across multiple teams creating systems for training and inference of machine learning models underpinning products such as [Codec Avatars](https://youtu.be/MVYrJJNdrEg?si=a213ml-XoaPBdV5a){:target="_blank"}, [Orion Augmented Reality Glasses](https://www.meta.com/blog/quest/orion-ar-glasses-augmented-reality/){:target="_blank"}, and [Instagram Ads Auto-Optimization](https://www.facebook.com/business/help/348328642954708){:target="_blank"}.  Contributed production code and technical direction in areas such as algorithm development, systems engineering, performance optimization for CPUs and GPUs, and general software engineering.
